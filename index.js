...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.asteroid161();
	this.instance.setTransform(-197.95,-171.65,2.5057,2.5057);
...
p.nominalBounds = new cjs.Rectangle(-197.9,-171.6,395.9,343.29999999999995);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.asteroid161();
	this.instance.setTransform(-79,-68.5);
...
p.nominalBounds = new cjs.Rectangle(-79,-68.5,158,137);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-758.65,-794.5,1.6674,1.6674);
...
p.nominalBounds = new cjs.Rectangle(-758.6,-794.5,1517.3000000000002,1589);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-314.5,-80);
...
p.nominalBounds = new cjs.Rectangle(-314.5,-80,629,160);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-446,-520.95);

	this.instance_1 = new lib.Tween13("synched",0);
	this.instance_1.setTransform(-14.5,441);
...
p.nominalBounds = new cjs.Rectangle(-446,-520.9,892,1041.9);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.text2();
	this.instance.setTransform(-446,-521);
...
p.nominalBounds = new cjs.Rectangle(-446,-521,892,1042);
...
p.nominalBounds = new cjs.Rectangle(-446,-915.9,892,1831.9);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-373,-1124.95);
...
p.nominalBounds = new cjs.Rectangle(-446,-1124.9,892,2249.9);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.text10();
	this.instance.setTransform(-373.05,-1124.95);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.hit).wait(260));

	// text
	this.instance = new lib.Tween12("synched",0);
	this.instance.setTransform(440.5,504);

	this.instance_1 = new lib.Tween14("synched",0);
	this.instance_1.setTransform(455,283);
	this.instance_1._off = true;

	this.instance_2 = new lib.Tween15("synched",0);
	this.instance_2.setTransform(455,1149.95);

	this.instance_3 = new lib.Tween20("synched",0);
	this.instance_3.setTransform(455,754.95);
	...
	this.instance_9 = new lib.text9pngcopy();
	this.instance_9.setTransform(72,80);

	this.instance_10 = new lib.Tween24("synched",0);
	this.instance_10.setTransform(451.05,1380.95);
	this.instance_10._off = true;

	this.instance_11 = new lib.Tween25("synched",0);
	this.instance_11.setTransform(851,1556.95);
	...
	this.instance_12.setTransform(339,330.5);
	this.instance_12._off = true;

	this.instance_13 = new lib.Tween23("synched",0);
	this.instance_13.setTransform(338.95,330.65);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_12}]},184).to({state:[{t:this.instance_13}]},75).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(184).to({_off:false},0).to({_off:true,x:338.95,y:330.65},75).wait(1));

	// spacecraft
	this.instance_14 = new lib.Tween16("synched",0);
	this.instance_14.setTransform(259.05,-98.5);
	this.instance_14._off = true;

	this.instance_15 = new lib.Tween17("synched",0);
	this.instance_15.setTransform(168.05,228.5);
	this.instance_15._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(94).to({_off:false},0).to({_off:true,x:168.05,y:228.5},35).wait(131));
	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(94).to({_off:false},35).to({scaleX:1.4685,scaleY:1.4685},26).to({x:598,y:268},29).to({_off:true},1).wait(75));

	// Layer_8
	this.instance_16 = new lib.Tween18("synched",0);
	this.instance_16.setTransform(586.65,476.5);
	this.instance_16._off = true;

	this.instance_17 = new lib.Tween19("synched",0);
	this.instance_17.setTransform(586.65,476.5,1.315,1.315);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_16}]},94).to({state:[{t:this.instance_17}]},35).to({state:[]},26).wait(105));
	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(94).to({_off:false},0).to({_off:true,scaleX:1.315,scaleY:1.315},35).wait(131));

	// spacex
	this.instance_18 = new lib.Tween10("synched",0);
	this.instance_18.setTransform(494.5,842);
	this.instance_18._off = true;

	this.instance_19 = new lib.Tween11("synched",0);
	this.instance_19.setTransform(494.5,-221);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_18}]},60).to({state:[{t:this.instance_19}]},34).to({state:[]},61).wait(105));
	this.timeline.addTween(cjs.Tween.get(this.instance_18).wait(60).to({_off:false},0).to({_off:true,y:-221},34).wait(166));

	// earth
	this.instance_20 = new lib.Tween7("synched",0);
	this.instance_20.setTransform(489.5,331);

	this.instance_21 = new lib.Tween8("synched",0);
	this.instance_21.setTransform(490,340);
	this.instance_21._off = true;

	this.instance_22 = new lib.Tween9("synched",0);
	this.instance_22.setTransform(503.5,355);
	this.instance_22._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_20).to({_off:true,x:490,y:340},19).wait(241));
	this.timeline.addTween(cjs.Tween.get(this.instance_21).to({_off:false},19).to({_off:true,x:503.5,y:355},20).wait(221));
	this.timeline.addTween(cjs.Tween.get(this.instance_22).wait(19).to({_off:false},20).to({startPosition:0},21).to({_off:true},1).wait(199));

	// Layer_2
	this.instance_23 = new lib.Tween5("synched",0);
	this.instance_23.setTransform(480,629.5);

	this.instance_24 = new lib.Tween6("synched",0);
	this.instance_24.setTransform(480,10.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_23}]}).to({state:[{t:this.instance_24}]},259).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_23).to({_off:true,y:10.5},259).wait(1));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(69.1,-299,1515.2,2980.9);
// library properties:
lib.properties = {
